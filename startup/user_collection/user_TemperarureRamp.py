...
class CapillaryHolderCustom(CapillaryHolder):
    def __init__(self, name='CapillaryHolder', base=None, **kwargs):
        ...
        self.temp_series_heating1 = np.arange(30, 100+.1, 10)
        self.temp_series_heating2 = np.arange(100, 150+.1, 5)
        self.temp_series_heating3 = np.arange(150, 220+.1, 2)
        #self.temp_series_heating2 = np.arange(100, 150, 5)
        #self.temp_series_heating3 = np.arange(150, 235+.1, 2)
        self.temp_series = np.concatenate((self.temp_series_heating1, self.temp_series_heating2, self.temp_series_heating3), axis=0)
    ...
    def doTemperature_ramp(self, step=0, exposure_time_SAXS=30.0, exposure_time_WAXS=30.0, temperature_probe='A', temperature_tolerance=0.4, wait_time=120, verbosity=3, x_offset=-1, x_step=+0.10, **md):
    ...
    def doTemperature_static(self, step=0, T_target=120, exposure_time_SAXS=30.0, exposure_time_WAXS=30.0, temperature_tolerance=0.2, wait_time=240, verbosity=3, x_offset=-1, x_step=+0.10, **md):
...
#class GIBarCustom(GIBar):
    ...
    def doTemperature_series(self, step=0, exposure_time_SAXS=10.0, exposure_time_WAXS=40.0, temperature_tolerance=0.4, wait_time=200, verbosity=3, x_offset=-1, x_step=+0.10, **md):
