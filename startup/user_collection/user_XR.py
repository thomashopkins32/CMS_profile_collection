...
#class GIBarCustom(GIBar):
    ...
    def doTemperature_series_heat(self, step=0, exposure_time_SAXS=30.0, exposure_time_WAXS=120.0, temperature_tolerance=0.4, wait_time=200, verbosity=3, x_step=0.20, **md):
...
def cooling(wait_time=5):
    sam1.gotoOrigin()
    sam1.measureIncidentAngle(.1,exposure_time=1)
    sam2.gotoOrigin()
    sam2.measureIncidentAngle(.1, exposure_time=1)
    time.sleep(wait_time)
