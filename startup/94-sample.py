    ...
    def search_plan(
        ...
        def inner_search():
            ...
            if fastsearch == True:
                ...
                if (
                    abs(
                        detector.stats2.max_xy.get().y
                        - detector.stats2.centroid.get().y
                    )
                    < 20
            ...
            if target == "max":
                if verbosity >= 5:
                    print(
                        "Performing search on axis '{}' target is 'max'".format(
                            self.name
                        )
                    )
                ...
                if verbosity >= 5:
                    print(
                        "Performing search on axis '{}' target is 'min'".format(
                            self.name
                        )
                    )
